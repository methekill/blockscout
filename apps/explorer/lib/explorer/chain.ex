defmodule Explorer.Chain do
  ...
  *NOTE*
  ...
  @spec delete_if_transactions_replaced([
          %{
  ...
  def delete_if_transactions_replaced(transactions, timeout \\ :infinity) do
    query =
    ...
    Repo.update_all(transactions_to_update, [set: [error: "dropped/replaced"]], timeout: timeout)
  end
